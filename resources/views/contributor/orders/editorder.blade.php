        ...
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text" required="required" value="{{$order->logo_name}}" name="logo_name" id="logo_name" class="form-control" placeholder="Enter Logo Name" />
                </div>
                <div class="form-group">
                    <label class="control-label">Category*</label>
                    <input type="text" required="required" value="{{$order->logo_cat}}" name="logo_category" id="logo_category" class="form-control" placeholder="Enter Category" />
                </div>
                
                <div class="form-group">
                    <label class="control-label">Target Audience</label>
                    <input type="text" name="target_audience" id="target_audience" value="{{$order->logo_target_audience}}" class="form-control" placeholder="Enter Target Audience" />
                </div>
                
                <div class="form-group">
                    <label class="control-label">Competitors URLs</label>
                    <input type="text"  name="compititor_url" id="compititor_url" value="{{$order->logo_competitor_url}}" class="form-control" placeholder="Enter Competitors URLs" />
                </div>
                
                <div class="form-group">
                    <label class="control-label">Slogan</label>
                    <input type="text" name="slogan" id="slogan" value="{{$order->logo_slogan}}" class="form-control" placeholder="Enter Slogan" />
                </div>
                
                <div class="form-group">
                    <label class="control-label">Website</label>
                    <input type="text" name="website_url" id="website_url" value="{{$order->logo_web_url}}" class="form-control" placeholder="Enter your Website link" />
                </div>
                
                <div class="form-group">
                    <label class="control-label">Description*</label>
                    <input type="text" name="descrp" id="descrp" value="{{$order->logo_name}}" class="form-control" required="required" placeholder="Enter Description" />
                </div>
                ...
                <div class="timeline-body">
                          ...
                          <img src="{{asset('/public/uploads/order_logo/'.$logo_sample)}}" alt="{{$order->title}}" class="margin" height="70px" width="80px">                        
                           @endforeach
                      </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="describe_imgs_dont_like" id="describe_imgs_dont_like" cols="50" rows="10">
                        {{$order->logo_visual_images}}
                    </textarea>
                </div>
                <h3>Logo type {{$order->logo_type}}</h3>
                <div class="form-group">
               ...
               <input type="checkbox"
                      @foreach($logotypes as $role)    @if($logodata->id==$role)) checked="checked"  @endif @endforeach name="logo_type[]" id="logo_type1" value="{{$logodata->id}}">
...
<input type="text" name="choose_color" id="choose_color" required="required" class="form-control" value="{{$order->logo_color}}" />
</div>
<div class="form-group">
<label class="control-label">Mention Your Specific Color (If any)</label>
<input type="text" name="other_color" id="other_color" class="form-control" value="{{$order->logo_other_color}}" />
</div>
...
<input type="checkbox" name="logo_usage[]" id="logo_usage1" value="{{$logodata->id}}"
       @foreach($logousages as $role)    @if($logodata->id==$role)) checked="checked"  @endif @endforeach
       >
@endforeach	
...
<input type="checkbox" name="font_type[]" id="font_type1" value="{{$fontdata->id}}"       
       @foreach($logofonts as $role)    @if($fontdata->id==$role)) checked="checked"  @endif @endforeach
       />
</div>
@endforeach
<span class="error-message" style="display: none">Please check atleast one checkbox!</span>
           ...
           <div class="form-group">
<label class="control-label">Mention Your Specific Color (If any)</label>
<input type="text" name="other_font_type" id="other_font_type" class="form-control" value="{{$order->logo_name}}" />
</div>
...
<input type="checkbox" name="logo_feel[]" id="logo_feel1" value="{{$logodata->id}}"              
       @foreach($logofeel as $role)    @if($logodata->id==$role)) checked="checked"  @endif @endforeach
       >
</div>
@endforeach		
<span class="error-message" style="display: none">Please check atleast one checkbox!</span>
        ...
        <div class="panel panel-primary setup-content" id="step-4">
            <div class="panel-heading">
                 <h3 class="panel-title"><h3>Upload If you have any files, images, sketches, or other documents</h3></h3>
            </div>
            <div class="panel-body">
                <div class="form-group">
<label class="control-label">Is there anything else you would like to communicate to our logo design team?</label>
<textarea name="communicate_designers" id="communicate_designers" cols="50" rows="10">{{$order->communication_team}}</textarea>
</div>
                <div class="form-group">
