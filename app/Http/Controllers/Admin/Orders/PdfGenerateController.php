...
class PdfGenerateController extends Controller
{
    ...
    public function orderPdfGenerate()
    {
        ...
        $pdf = PDF::loadView('admin/orders/pdfview', array('page_title'=>'Generate Orders PDF Report','orders'=>$orders,'settings'=>$setting));
    ...
    public function generateOrderPdf($order_id)
    {
        ...
        $pdf = PDF::loadView('admin/orders/pdforderview', array('page_title'=>'Order PDF','orders'=>$orders,'user'=>$user,'setting'=>$setting,'packages'=>$packages,'order_type'=>$order_type,'payment_adon'=>$payment_adon,'payment'=>$payment,'settings'=>$setting,'coupon_code'=>$coupon_code));
