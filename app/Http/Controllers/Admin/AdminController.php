...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        { 
            ...
            return view('admin.dashboard')->with('page_title', "Admin Dashboard")->with("coupon_codes",$coupons)->with("packages",$packages)->with("logo_type",$logo_type)->with("logo_feel",$logo_feel)->with("payment_adon",$payment_adon)->with("logo_usage",$logo_usage)->with("logo_fonts",$logo_fonts);
         }else
        {      
            Auth::logout();
